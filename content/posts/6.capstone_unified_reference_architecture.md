...
2. **[Part 2]({{< ref "3.orthogonal_architecture_extension_layer.md" >}}) Orthogonal Extensions:** Separate the Y-Axis (Core) from the X-Axis (Side-effects).
3. **[Part 3]({{< ref "4.global_governance_distributed_ordering.md" >}}) Global Governance:** Destroy distributed magic (`@Order`); centralize the execution topology.
4. **[Part 4]({{< ref "5.immutable_pipeline_zero_cost_rollback.md" >}}) Immutable Pipelines:** Enable constant-time rollback semantics in memory.
