---
title: "From Contention to Throughput (5/5): The Grand Finale — Database / Queue vs Kafka vs Workflow Engines"
date: 2026-04-13
tags: ["distributed-systems", "kafka", "temporal", "postgresql", "architecture"]
series: ["From Contention to Throughput"]
series_order: 5
summary: "The ultimate decision framework. We resolve the holy war between Database / Queue primitives, Event Streams, and Workflow Engines by defining state lifespan and coordination boundaries."
draft: false
math: false
mermaid: true
---
...
## ☯️ 1. The Ideological War & The Core Confusion
...
### 🌱 2.1 The Database / Queue (PostgreSQL / MySQL)
...
## 🧭 3. The Architectural Decision Framework
...
## 🏛️ 4. The Architectural Doctrine
...
## 🗝️ 5. The "Brick" Summary (Mental Model)
...
* **🏛️ Invariant:** Using an Event Stream to mimic a transactional State Machine without explicit compensation protocols is a category error that will surface as data inconsistency under failure.
