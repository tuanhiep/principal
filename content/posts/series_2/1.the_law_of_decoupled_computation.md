...
This principle is the root of several advanced architectural patterns:
...
### 🧠 3.1 The Decision Framework: When to Move the Work
...
### 🛠️ 4.2 The Core Skeleton (The Implementation)
...
## ☯️ 5. Production Realism & Trade-offs
...
## ✨ 6. The Mindset (💡 Google System Mindset)

* 🚀 **Tail Latency:** Moving work out of the request path is the only way to flatten the p99 curve at high percentiles.
* 🌐 **Scalability:** By reducing the API to a state transition, the database acts as a simple state machine rather than a computation engine, enabling massive horizontal scaling.
