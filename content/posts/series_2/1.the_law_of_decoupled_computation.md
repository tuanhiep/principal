...
The problem is not *how fast* we compute or *where* we check it. The problem is **when** we are doing the work. You are forcing the user to wait while the server thinks. You are not solving a performance issue. You are misplacing time in the system.
---
