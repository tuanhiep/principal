...
-- Partial Index for high-speed SKIP LOCKED scans (from Part 2)
...
5. **T35:** Pod A wakes up, unaware it was asleep. Both Pod A and Pod B now think they own ID #42. 
...
```sql
-- The Final Commit (Fenced at the Database/System of Record)
...
### ⚖️ 6.3 Lease Duration: The Strategic Trade-off
...
* **💠 Pivot Insight:** Systems do not scale when locks are optimized—it scales when locks are no longer part of the critical path. 
