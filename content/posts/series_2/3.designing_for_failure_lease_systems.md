---
title: "From Contention to Throughput (3/5): Designing for Failure — Lease Systems & Distributed Recovery"
date: 2026-04-10
...
*This design review uses a challenger voice to break down the "Heartbeat" myth.*
...
## 🏛️ 5. The Law of Temporal Ownership
...
## ☯️ 6. Production Edge Cases

### ☯️ 6.1 The Resurrection Anomaly (GC Pauses)
...
### ⛩️ 6.2 The Fix: Fencing Tokens & Enforcement
...
#### 🌀 6.2.1 The Timeline of a Resurrection (Sequence Diagram)
...
### ☯️ 6.4 Clock Drift & Idempotency
* **Clock Drift:** Application-side time (`System.currentTimeMillis()`) is unreliable across distributed nodes. The database clock is the single source of temporal truth — `NOW()` is the correct choice.
