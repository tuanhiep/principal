---
title: "Enterprise Architecture Core (2/5): Orthogonal Architecture & The Extension Layer"
date: 2026-03-28
...
> 🌸 *The vertical axis guards the primary flow,*
> *While orthogonal satellites orbit below.*
> *Keep the inner core blind to the outer design,*
> *And the expanding system will perfectly align.*

## 🌠 1. The Formal Specification (Problem Model)

In [Part 1]({{< ref "1.routing_as_first_class_problem.md" >}}), we successfully decoupled our payment routing logic into isolated `ExecutionPlugins`. The Core is now clean. However, in an Enterprise environment, executing the core domain is only 20% of the workload.
...
*The deeper architectural risk is that inserting side-effects into core execution is how a "God Class" is born.*
...
### 🏛️ 3.1 The "Core Blindness" Contract (Invariant)
...
### ♙️ 3.3 Why Not Spring `@EventListener` or Kafka?
...
### 🗺️ 3.4 The Orthogonal Matrix Diagram
...
### ⚠️ Trap 1: The Silent Data Drift
...
### ⚠️ Trap 2: The Fallacy of Independence
...
> **Next up**: In [Part 3]({{< ref "3.global_governance_distributed_ordering.md" >}}), we face the inevitable consequence of our Extension Layer. When 50 extensions compete to execute, relying on Spring's `@Order` creates a "Global Blindness" that brings deployments to a halt. We will explore **Global Governance** and the **Centralized Static Registry** to regain control of the chaos.
